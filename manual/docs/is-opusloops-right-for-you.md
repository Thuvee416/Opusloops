# Is Opusloops Right for You?

Opusloops is a good fit when you want to:

- Sketch a loop quickly on a phone or tablet
- Work through direct touch rather than desktop menus
- Use a small built-in Web Audio palette
- Keep projects local and install a lightweight PWA
- Focus on sequencing and a compact mix without configuring plugins

It may not be the right fit when you need:
