...
The production Opusloops application is the mobile web/PWA in [`mobile/`](https://github.com/Thuvee416/Opusloops/tree/main/mobile).
...
See [NOTICE.md](https://github.com/Thuvee416/Opusloops/blob/main/NOTICE.md) for upstream attribution and [LICENSE](https://github.com/Thuvee416/Opusloops/blob/main/LICENSE) for the GPL-3.0 terms.
